...
Chest Press machine — 3 x 12 | RPE 6-7
Shoulder Press machine — 3 x 12 | RPE 6-7
Pec Dec (butterfly) — 3 x 12 | RPE 6-7
Tricep Pushdown cable — 3 x 12 | RPE 6-7
Plank — 3 x 30s
...
Lat Pulldown — 3 x 12 | RPE 6-7
Cable Row — 3 x 12 | RPE 6-7
Bicep Curl machine — 3 x 12 | RPE 6-7
Leg Press — 3 x 12 | RPE 6-7
Leg Curl — 3 x 12 | RPE 6-7
...
Chest Press machine — 3 x 12 | RPE 6-7
Lat Pulldown — 3 x 12 | RPE 6-7
Shoulder Press machine — 3 x 10 | RPE 6-7
Leg Press — 3 x 12 | RPE 6-7
Cable Row — 3 x 10 | RPE 6-7
Plank — 3 x 30s
...
Distance : 6 km
Allure : 5:30-5:45/km
FC : Zone 2 (tu peux parler)
Chaussures : NB Fresh Foam 1080

Reste en Zone 2 — résiste à l'envie d'accélérer
    """,
    "jeudi": """
🏃 *JEUDI — TEMPO*
_Séance qualité_
...
Ne dépasse pas 5:10/km sur les blocs
    """,
    "samedi": """
...
Attention : tu accélères souvent en fin de sortie — tiens l'allure jusqu'au bout
    """
}
...
4 oeufs brouillés + 2 tranches pain complet + lait
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "💪 *Salut Reda !*\n\nJe suis ton coach personnel. Utilise les boutons ci-dessous.",
        parse_mode='Markdown',
...
async def today(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if day in programme:
        await update.message.reply_text(
            f"Aujourd'hui : *{day.capitalize()}* — séance salle :\n{programme[day]}",
            parse_mode='Markdown',
            reply_markup=main_keyboard
        )
    elif day in course:
        await update.message.reply_text(
            f"Aujourd'hui : *{day.capitalize()}* — course :\n{course[day]}",
            parse_mode='Markdown',
            reply_markup=main_keyboard
        )
    else:
        await update.message.reply_text(
            "😴 *Vendredi — Repos complet*\n\nRécupération. Mange bien, dors bien.\nDemain c'est la sortie longue 💪",
            parse_mode='Markdown',
            reply_markup=main_keyboard
        )
